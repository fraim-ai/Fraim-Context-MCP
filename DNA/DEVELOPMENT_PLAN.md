...
|-------|------|--------|-------|----------------|
| 0 | Environment Setup | ⬜ Not Started | `tests/stage_0/` | Scripts only |
| 1 | Database Layer | ⬜ Not Started | `tests/stage_1/` | `src/fraim_mcp/database/` |
| 2 | LLM & Embeddings | ⬜ Not Started | `tests/stage_2/` | `src/fraim_mcp/llm/` |
| 3 | Retrieval Pipeline | ⬜ Not Started | `tests/stage_3/` | `src/fraim_mcp/retrieval/` |
| 4 | MCP Server | ⬜ Not Started | `tests/stage_4/` | `src/fraim_mcp/server/` |
| 5 | Integration | ⬜ Not Started | `tests/stage_5/` | Full system |
...
- [ ] **Test**: `tests/stage_0/test_doppler.py::test_doppler_cli_available`
- [ ] **Test**: `tests/stage_0/test_doppler.py::test_doppler_authenticated`
- [ ] **Test**: `tests/stage_0/test_doppler.py::test_doppler_project_configured`
...
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_database_url_present`
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_database_url_valid_format`
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_redis_url_present`
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_redis_url_valid_format`
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_openrouter_api_key_present`
- [ ] **Test**: `tests/stage_0/test_secrets.py::test_logfire_token_present`
...
- [ ] **Test**: `tests/stage_0/test_connectivity.py::test_postgresql_connection`
- [ ] **Test**: `tests/stage_0/test_connectivity.py::test_postgresql_pgvector_extension`
- [ ] **Test**: `tests/stage_0/test_connectivity.py::test_redis_connection`
- [ ] **Test**: `tests/stage_0/test_connectivity.py::test_openrouter_api_reachable`
- [ ] **Test**: `tests/stage_0/test_connectivity.py::test_logfire_api_reachable`
...
**Stage 0 Complete**: [ ] (check when all tests pass)
...
**Stage 1 Complete**: [ ] (check when all tests pass)
...
**Stage 2 Complete**: [ ] (check when all tests pass)
...
**Stage 3 Complete**: [ ] (check when all tests pass)
...
**Stage 4 Complete**: [ ] (check when all tests pass)
